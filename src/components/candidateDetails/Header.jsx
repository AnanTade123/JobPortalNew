...
function Header() {
  return (
    <>
      <div className="flex flex-col items-center bg-gradient-to-r from-[#345b4a] via-[#244034] to-[#345b4a] h-[250px] sm:h-[350px] md:h-[350px] lg:h-[350px] max-w-[1545px] mx-auto">
