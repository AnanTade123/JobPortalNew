  ...
  return (
    <header className="bg-black shadow-lg relative">
      <div className="container mx-auto flex items-center justify-between p-4 lg:px-8">
        ...
        {/* Nav Links */}
        <nav className="hidden lg:flex space-x-8 text-gray-800 font-medium relative">
        ...
        {/* Mobile Menu Toggle */}
        <button className="lg:hidden bg-[#255741] text-black border-black px-3 py-3" onClick={toggleMenu}>
      ...
      {isOpen && (
        <div className="lg:hidden bg-[#255741] shadow-md w-1/2">
          ...
          <div className="p-1 space-y-2">
            ...
            <button className="w-36 bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">Post a job</button>
          </div>
        </div>
      )}
    </header>
