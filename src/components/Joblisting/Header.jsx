    ...
    return (
      <>
        <div className="bg-[#244034] w-full h-[400px] relative ">
          ...
          {/* Search Box */}
          <div className="w-[80%] lg:w-[881px] rounded-lg absolute left-4 md:left-[80px] lg:left-[320px] top-[180px] md:top-[150px] lg:top-[260px] h-[120px] sm:left-[50px]">
            <div className="flex flex-col lg:flex-row bg-white rounded-lg shadow-md">
              {/* Location Input */}
              <div className="flex-1 px-4 py-3 lg:py-7 border-b lg:border-b-0 lg:border-r border-gray-300 h-[90px] lg:h-[115.5px]">
              ...
              {/* Search Button */}
              <button className="bg-lime-400 text-black font-semibold px-6 py-3 w-full h-[70px] lg:w-[140px] lg:h-[115.5px] rounded-b-lg lg:rounded-r-lg lg:rounded-bl-none">
  SEARCH
</button>
